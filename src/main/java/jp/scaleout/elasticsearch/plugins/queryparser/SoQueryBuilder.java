...
package jp.scaleout.elasticsearch.plugins.queryparser;
 ...
 * <p/>
 */
public class SoQueryBuilder extends QueryBuilder implements BoostableQueryBuilder<SoQueryBuilder> {
    ...
    public SoQueryBuilder(String queryString) {
     ...
     */
    public SoQueryBuilder defaultField(String defaultField) {
     ...
     */
    public SoQueryBuilder field(String field) {
        if (fields == null) {
            fields = newArrayList();
        }
        fields.add(field);
     ...
     */
    public SoQueryBuilder field(String field, float boost) {
        if (fields == null) {
            fields = newArrayList();
        }
        fields.add(field);
     ...
     */
    public SoQueryBuilder useDisMax(boolean useDisMax) {
     ...
     */
    public SoQueryBuilder tieBreaker(float tieBreaker) {
     ...
     */
    public SoQueryBuilder defaultOperator(Operator defaultOperator) {
     ...
     */
    public SoQueryBuilder analyzer(String analyzer) {
     ...
     * defined for it, then it will be used automatically. Defaults to the smart search analyzer.
     */
    public SoQueryBuilder quoteAnalyzer(String analyzer) {
     ...
     */
    public SoQueryBuilder autoGeneratePhraseQueries(boolean autoGeneratePhraseQueries) {
     ...
     */
    public SoQueryBuilder maxDeterminizedStates(int maxDeterminizedStates) {
     ...
     */
    public SoQueryBuilder allowLeadingWildcard(boolean allowLeadingWildcard) {
     ...
     */
    public SoQueryBuilder lowercaseExpandedTerms(boolean lowercaseExpandedTerms) {
     ...
     */
    public SoQueryBuilder enablePositionIncrements(boolean enablePositionIncrements) {
     ...
     */
    public SoQueryBuilder fuzziness(Fuzziness fuzziness) {
     ...
     */
    public SoQueryBuilder fuzzyPrefixLength(int fuzzyPrefixLength) {
        this.fuzzyPrefixLength = fuzzyPrefixLength;
        return this;
    }

    public SoQueryBuilder fuzzyMaxExpansions(int fuzzyMaxExpansions) {
        this.fuzzyMaxExpansions = fuzzyMaxExpansions;
        return this;
    }

    public SoQueryBuilder fuzzyRewrite(String fuzzyRewrite) {
     ...
     */
    public SoQueryBuilder phraseSlop(int phraseSlop) {
     ...
     */
    public SoQueryBuilder analyzeWildcard(boolean analyzeWildcard) {
        this.analyzeWildcard = analyzeWildcard;
        return this;
    }

    public SoQueryBuilder rewrite(String rewrite) {
        this.rewrite = rewrite;
        return this;
    }

    public SoQueryBuilder minimumShouldMatch(String minimumShouldMatch) {
     ...
     */
    @Override
    public SoQueryBuilder boost(float boost) {
        this.boost = boost;
        return this;
    }
     ...
     */
    public SoQueryBuilder quoteFieldSuffix(String quoteFieldSuffix) {
     ...
     */
    public SoQueryBuilder lenient(Boolean lenient) {
     ...
     */
    public SoQueryBuilder queryName(String queryName) {
        this.queryName = queryName;
        return this;
    }

    public SoQueryBuilder locale(Locale locale) {
        this.locale = locale;
        return this;
    }
     ...
     */
    public SoQueryBuilder timeZone(String timeZone) {
     ...
     */
    public SoQueryBuilder escape(boolean escape) {
        this.escape = escape;
        return this;
    }
